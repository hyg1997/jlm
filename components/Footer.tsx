  ...
  return (
    <footer className="bg-gradient-to-br from-gray-900 via-slate-900 to-gray-900 text-white relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-indigo-500/5 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '2s' }}></div>
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div className="space-y-6 animate-in fade-in slide-in-from-bottom duration-1000">
            ...
            <p className="text-gray-300 text-base leading-relaxed">
              Protegemos lo que más valoras con tecnología de seguridad de vanguardia 
              y monitoreo profesional las 24 horas del día.
            </p>
          </div>
          ...
          <div className="space-y-6 animate-in fade-in slide-in-from-bottom duration-1000 delay-200">
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/camaras-de-seguridad" className="text-gray-300 hover:text-blue-400 transition-all duration-300 hover:translate-x-1 inline-block">
                  Cámaras de Seguridad
                </Link>
              </li>
              <li>
                <Link href="/servicios" className="text-gray-300 hover:text-blue-400 transition-all duration-300 hover:translate-x-1 inline-block">
                  Servicios
                </Link>
              </li>
              <li>
                <Link href="/faq" className="text-gray-300 hover:text-blue-400 transition-all duration-300 hover:translate-x-1 inline-block">
                  Preguntas Frecuentes
                </Link>
              </li>
              <li>
                <Link href="/contacto" className="text-gray-300 hover:text-blue-400 transition-all duration-300 hover:translate-x-1 inline-block">
                  Contacto
                </Link>
              </li>
            </ul>
          ...
          <div className="space-y-6 animate-in fade-in slide-in-from-bottom duration-1000 delay-400">
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-2">
                ...
                <Link href={`tel:${data.contact.phone}`} className="text-gray-300 hover:text-white transition-colors">
                  {data.contact.phone}
                </Link>
              </div>
              <div className="flex items-center space-x-2">
                <Mail className="h-4 w-4 text-blue-400" />
                <Link href={`mailto:${data.contact.email}`} className="text-gray-300 hover:text-white transition-colors">
                  {data.contact.email}
                </Link>
              </div>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <p className="text-center text-gray-400 text-base animate-in fade-in duration-1000 delay-500">
            © 2025 Arcring Perú. Todos los derechos reservados.
          </p>
        </div>
      </div>
    </footer>
