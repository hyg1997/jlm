...
export default function Header() {
  ...
  return (
    ...
    <div className={`fixed inset-0 z-40 lg:hidden transition-all duration-500 ${
      ...
      {/* Menu Panel */}
      <div className={`absolute right-0 top-0 h-full w-full bg-white transform transition-transform duration-500 ease-out ${
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="flex-1 px-8 py-12">
            ...
            <div className="mt-12 space-y-4">
              <Link href="tel:+51974598249" onClick={() => setIsMenuOpen(false)}>
              ...
              <div className="pt-8 space-y-4 text-center">
                ...
                <div className="space-y-2">
                  <p className="text-lg font-semibold text-gray-900">+51 974 598 249</p>
